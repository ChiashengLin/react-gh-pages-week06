...
function App() {
  ...
  const productModalRef = useRef(cnull);
  useEffect(() => {
            ...
            <tbody>
                ...
                <tr key={product.id}>
                    ...
                    <div className="btn-group btn-group-sm">
                        ...
                        <button onClick={() => addCartItem(product.id, 1)} type="button" disable={isLoading} className="btn btn-danger d-flex align-items-center gap-2">
                        加到購物車
